...
<!-- Nav tabs -->
<ul class="nav nav-tabs justify-content-end" id="navId">
    <li class="nav-item">
        <a href="#tab1Id" class="nav-link active">Tableau de bord</a>
    </li>
    <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Pages du site</a>
    ...
    <li class="nav-item">
        <a href="#tab5Id" class="nav-link">Mail</a>
    </li>
    <li class="nav-item">
